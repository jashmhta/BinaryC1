      ...
      <section className="py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-primary dark:text-teal-400 mb-6">Infrastructure Development Financing</h2>
            ...
            <div className="mb-12 rounded-lg overflow-hidden shadow-xl dark:shadow-gray-900/50">
              <img src="/project_finance_card.png" alt="Project Finance Solutions" loading="lazy" className="w-full h-auto" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="text-center p-6 bg-gray-50 dark:bg-gray-900 rounded-lg">
                ...
                <div className="text-gray-600 dark:text-gray-300">Project financing arranged</div>
              </div>
              <div className="text-center p-6 bg-gray-50 dark:bg-gray-900 rounded-lg">
                <div className="text-4xl font-bold text-secondary mb-2">50+</div>
                <div className="text-gray-600 dark:text-gray-300">Infrastructure projects financed</div>
              </div>
              <div className="text-center p-6 bg-gray-50 dark:bg-gray-900 rounded-lg">
                <div className="text-4xl font-bold text-secondary mb-2">15+</div>
                <div className="text-gray-600 dark:text-gray-300">Years average project tenure</div>
              </div>
            </div>
            ...
            {/* Sectors We Finance */}
            <h3 className="text-3xl font-bold text-primary dark:text-teal-400 mb-8">Sectors We Finance</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
                ...
                <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-3">Infrastructure</h4>
                <p className="text-gray-600 dark:text-gray-300">Roads, bridges, airports, and transportation systems</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
                <div className="w-12 h-12 bg-secondary rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-primary dark:text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-3">Energy</h4>
                <p className="text-gray-600 dark:text-gray-300">Power plants, renewable energy, and transmission lines</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
                <div className="w-12 h-12 bg-secondary rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-primary dark:text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-3">Water & Utilities</h4>
                <p className="text-gray-600 dark:text-gray-300">Water treatment, waste management, and utility networks</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
                <div className="w-12 h-12 bg-secondary rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-primary dark:text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-3">Real Estate</h4>
                <p className="text-gray-600 dark:text-gray-300">Commercial developments and mixed-use projects</p>
              </div>
            </div>

            {/* Project Finance Advantages */}
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-8 mb-16">
              <h3 className="text-3xl font-bold text-primary dark:text-teal-400 mb-6">Project Advisory Advantages</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Non-recourse or limited recourse financing</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Long-term funding for infrastructure projects</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Risk allocation among project stakeholders</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Special Purpose Vehicle (SPV) structuring</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Comprehensive due diligence and feasibility studies</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Regulatory and environmental compliance support</span>
                </li>
              </ul>
            </div>
          </div>
