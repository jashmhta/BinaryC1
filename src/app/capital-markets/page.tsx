      ...
      <section className="py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-primary dark:text-teal-400 mb-6">Connect with Global Investors</h2>
            ...
            <div className="mb-12 rounded-lg overflow-hidden shadow-xl dark:shadow-gray-900/50">
              <img src="/capital_markets_card.png" alt="Capital Markets Solutions" loading="lazy" className="w-full h-auto" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="text-center p-6 bg-gray-50 dark:bg-gray-900 rounded-lg">
                ...
                <div className="text-gray-600 dark:text-gray-300">Capital raised</div>
              </div>
              <div className="text-center p-6 bg-gray-50 dark:bg-gray-900 rounded-lg">
                <div className="text-4xl font-bold text-secondary mb-2">75+</div>
                <div className="text-gray-600 dark:text-gray-300">Transactions completed</div>
              </div>
            </div>
            ...
            {/* Our Offerings */}
            <h3 className="text-3xl font-bold text-primary dark:text-teal-400 mb-8">Our Offerings</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
                <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-3">Equity Capital Markets</h4>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
                <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-3">Debt Capital Markets</h4>
                <ul className="space-y-2 text-gray-600 dark:text-gray-300">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
                <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-3">Private Placements</h4>
                <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                  <li>• Institutional placements</li>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
                <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-3">Cross-border Transactions</h4>
                <ul className="space-y-2 text-gray-600 dark:text-gray-300">
            ...
            {/* Transaction Process */}
            <h3 className="text-3xl font-bold text-primary dark:text-teal-400 mb-8">Transaction Process</h3>
            <div className="space-y-6 mb-16">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-2">Preparation</h4>
                  <p className="text-gray-700 dark:text-gray-200">Financial due diligence, documentation, and regulatory filings</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-2">Marketing</h4>
                  <p className="text-gray-700 dark:text-gray-200">Investor presentations, roadshows, and market education</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h4 className="text-xl font-bold text-primary dark:text-teal-400 mb-2">Pricing</h4>
                  <p className="text-gray-700 dark:text-gray-200">Book building, price discovery, and allocation decisions</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 dark:text-gray-200">Transaction completion and settlement processes</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-8 mb-16">
              <h3 className="text-3xl font-bold text-primary dark:text-teal-400 mb-6">Why Choose Us</h3>
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Optimal pricing and market timing</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Regulatory expertise and compliance</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Strong institutional relationships</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Post-transaction support</span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary text-2xl mr-3">✓</span>
                  <span className="text-gray-700 dark:text-gray-200">Market intelligence and insights</span>
                </li>
              </ul>
            </div>

            {/* Our Services */}
            <h3 className="text-3xl font-bold text-primary dark:text-teal-400 mb-6">Our Services</h3>
